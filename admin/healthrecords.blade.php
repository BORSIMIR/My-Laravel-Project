    ...
    <div class="container-scroller">
      ...
      <div align="" style="padding-top: 100px;">
        ...
        <form action="{{url('search1')}}" method="get">
        	<a href="{{route('export_patient_pdf4')}}" class="btn btn-success">Convert All Into PDF</a>
        ...
        <table class="table" id="myhealth">
          ...
          <thead>
            ...
            <th style="text-align:center;">Print PDF</th>
            </tr>
            </thead>
            ...
            <td><a class="btn btn-primary" href="{{url('updatetotaluser',$user->id)}}">Add</a></td>
