        ...
        @endif
          ...
          <form action="{{url('edittotaluser',$data->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div style="padding: 15px;">             
              ...
              <input type="text" style="color:black" name="name" value="{{$data->name}}, {{$data->fullname}} {{$data->mname}}">
            </div>
            ...
            <div style="padding: 15px;">             
              ...
              <input type="date" style="color:black" name="birthdate" value="{{$data->birthdate}}">
            </div>
            ...
            <div style="padding: 15px;">             
              <label>Sex</label>
              <input type="text" style="color:black" name="sex" value="{{$data->sex}}">
            </div>

            <div style="padding: 15px;">             
              <label>Civil Status</label>
              <input type="text" style="color:black" name="civil" value="{{$data->civil}}">
            </div>
